...
const ToolbarProvider = (props) => {
  ...
  const setCurrentToolbarData = useCallback(
  ...
  const close = useCallback(() => {
    ...
    clearCurrentToolbarData()
  }, [state, removeToolbar, clearCurrentToolbarData])
...
const useToolbar = () => {
  ...
  if (!context) {
    throw new Error(
      'Invalid use of useToolbar, ToolbarProvider must be defined in parent hierarchy'
    )
  }
  return context
}
