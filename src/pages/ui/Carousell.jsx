...
const IndicatorContainer = (props) => {
  const { position, total, handleClick, indicatorIcon } = props
...
const CarouselUI = (className, indicators, indicatorIcon) => (props) => {
  const { position, total, handleClick, children } = props
...
const Carousel = (props) => {
  ...
  const CarouselWrapper = makeCarousel(
    CarouselUI(className, indicators, indicatorIcon)
  )
