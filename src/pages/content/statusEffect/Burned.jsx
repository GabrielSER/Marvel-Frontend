  ...
  return (
    <StatusContainer>
      <StatusText title='Burned'>
        Each turn, a burned character must take 1d6 damage at the beggining of their turn. While burned, this
        ...
        fire extinguisher or until it makes a Durability throw of 14 at the end of their turn. Doesn’t
        apply underwater.
      </StatusText>
      <StatusImage
        src={image}
