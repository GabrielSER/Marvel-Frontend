  ...
  return (
    ...
    >
      ...
      <Section>
        ...
        <Paragraph>
          The GM describes the scenes, environments, and events that unfold in
          the game. This includes providing details about the characters'
          surroundings, the appearance of NPCs, and the outcomes of their
          actions.
        </Paragraph>
        ...
        <Paragraph>
          ...
          provides the players with characters to interact with.
        </Paragraph>
        ...
        <Paragraph>
          ...
          the players to make decisions and roleplay their responses.
        </Paragraph>
        ...
        <Paragraph>
          ...
          actions, and engage in creative problem-solving.
        </Paragraph>
        ...
        <Paragraph>
          ...
          collaborative storytelling within the group.
        </Paragraph>
        <div className='flex justify-center'>
          {' '}
          {/* Added a flex container for centering */}
