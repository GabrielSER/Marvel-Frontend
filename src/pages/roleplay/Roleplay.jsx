  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen space-y-4">
      <div className="max-w-5xl p-2 mx-auto items-center">
        <h1 className="text-5xl font-semibold mt-4 text-center p-8">ROLEPLAYING ACTIONS</h1>
        <p className="text-gray-700 mb-6 text-center mx-auto sm:px-0 px-10">
      ...
      <div className="max-w-5xl p-2 mx-auto items-center sm:px-0 px-10">
        ...
        <div className="flex justify-center"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-lg max-w-xs rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={FirstFamily}
            alt="FF"
          />
        </div>
      ...
      <div className='flex sm:flex-row flex-col'>
        <div className="max-w-5xl p-2 mx-auto items-center px-20">
          ...
          <div className="flex justify-center"> {/* Added a flex container for centering */}
            <img
              className="sm:max-w-md max-w-xs rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
              src={Lifting}
              alt="Lift Table"
            />
          </div>
        </div>
        <div className="flex justify-center sm:pr-28 pr-0 sm:pl-16 pl-0 py-10"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-sm max-w-xs h-max rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={Shehulk}
            alt="Lift Table"
          />
        </div>
      ...
      <div className="max-w-5xl p-2 mx-auto items-center">
        ...
        <div className="flex justify-center"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-2xl max-w-xs rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={Throw1}
            alt="Throw Table 1"
          />
        </div>
      ...
      <div className="max-w-5xl p-2 mx-auto items-center">
        ...
        <div className="flex justify-center"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-5xl max-w-xs rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={Crush}
        ...
        <div className="flex justify-center"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-4xl max-w-xs rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={Destiny}
      ...
      <div className='flex sm:flex-row flex-col'>
        ...
        <div className="flex justify-center sm:pr-28 pr-0 sm:pl-16 pl-0 hidden sm:block py-10"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-sm max-w-xs h-max rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={HulkJump}
            alt="Hulk Jump"
      ...
      <div className='flex sm:flex-row flex-col'>
        <div className="flex justify-center sm:pl-28 pl-0 sm:pr-16 pr-0 py-10"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-sm max-w-xs h-max rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={CapJump}
      ...
      <div className='flex sm:flex-row flex-col'>
        <div className="max-w-5xl p-2 mx-auto items-center px-20">
          ...
          <div className="flex justify-center"> {/* Added a flex container for centering */}
            <img
              className="sm:max-w-xs max-w-xs rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
              src={Flytable}
      ...
      <div className='flex sm:flex-row flex-col'>
        <div className="flex justify-center sm:pl-28 pl-0 sm:pr-16 pr-0 py-10 hidden sm:block "> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-sm max-w-xs h-max rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={Ironfly}
            alt="Iron Man Flying"
      ...
      <div className='flex sm:flex-row flex-col mb-4'>
        ...
        <div className="flex justify-center sm:pr-28 pr-0 sm:pl-16 pl-0"> {/* Added a flex container for centering */}
          <img
            className="sm:max-w-sm max-w-xs h-max rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mb-6"
            src={GreenGoblin}
            alt="Super Villain"
