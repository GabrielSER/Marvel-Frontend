...
import LazyImage2 from '../ui/LazyImage2'; // Importing LazyImage2
...
const CharacterImage = () => {
  ...
  const imagePlaceholder = (
    <div class="flex flex-col pt-24 lg:pt-52" role="status">
      <svg aria-hidden="true" class="w-20 lg:w-40 h-10 lg:h-20 text-gray-400 animate-spin dark:text-gray-600 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    ...
    >
      ...
      <LazyImage2 // Using LazyImage2 component
        ...
        imageClassname={clsx(
          'sm:p-0 h-full object-cover rounded-md',
          { 'flip-in': isLoaded }
        )}
