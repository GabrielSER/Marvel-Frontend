...
const CharacterImage = () => {
  ...
  const imagePlaceholder = (
    <div class="flex flex-col pt-52" role="status">
      <svg aria-hidden="true" class="w-40 h-40 text-gray-400 animate-spin dark:text-gray-600 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
